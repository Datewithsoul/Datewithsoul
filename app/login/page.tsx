  ...
  return (
    <div className="min-h-screen bg-[#FFFDF5] text-[#5D4037] font-sans flex flex-col">
      ...
      <main className="flex-1 flex items-center justify-center p-8 bg-[url('/dot-pattern.png')] bg-repeat">
        <div className="bg-white border-4 border-[#5D4037] rounded-3xl p-8 shadow-[8px_8px_0_0_#5D4037] w-full max-w-md">
          ...
          <form action={login} className="flex flex-col gap-6">
            ...
            <button 
              type="submit"
              className="mt-4 bg-[#FFEB3B] text-[#5D4037] p-4 rounded-xl font-black text-xl border-4 border-[#5D4037] shadow-[4px_4px_0_0_#5D4037] hover:translate-y-1 hover:shadow-[2px_2px_0_0_#5D4037] transition-all tracking-widest"
            >
              ล็อคอิน
            </button>
          </form>
          ...
          <div className="mt-8 text-center font-bold">
            ยังไม่มีบัญชีใช่ไหม? <Link href="/register" className="text-[#F44336] underline hover:text-[#5D4037]">สมัครสมาชิกเลย</Link>
          </div>
        </div>
      </main>
