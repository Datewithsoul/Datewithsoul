...
const faqCategories = [
  ...
  {
    category: "การยกเลิกและคืนเงิน",
    items: [
      {
        q: "ยกเลิกการจองได้หรือไม่?",
        a: "สามารถยกเลิกได้โดยไปที่หน้าประวัติการจอง กดปุ่มยกเลิก หรือแจ้งผ่าน LINE Official Account",
      },
      {
        q: "ยกเลิกแล้วได้รับเงินคืนไหม?",
        a: "นโยบายการคืนเงินขึ้นอยู่กับระยะเวลาก่อนวันเรียน กรุณาดูรายละเอียดในหน้าเงื่อนไขการจอง หรือติดต่อเราโดยตรง",
      },
      {
        q: "หากคลาสถูกยกเลิกโดยทางร้าน จะได้รับเงินคืนไหม?",
        a: "ได้รับเงินคืนเต็มจำนวน ทีมงานจะติดต่อแจ้งและดำเนินการคืนเงินภายใน 7 วันทำการ",
      },
    ],
  },
  {
